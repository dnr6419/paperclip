"""
Aroon Oscillator backtest on KRX real data.
In-Sample: 2019-2022, Out-of-Sample: 2023-2024.
Parameter optimization: period, threshold, stop_loss, take_profit.
"""
...
from strategies.aroon_oscillator import AroonOscillatorStrategy
...
def cross_sectional_aggregate(per_stock_results, strategy_name="Aroon Oscillator"):
...
def optimize(stock_data):
    ...
    for combo in combos:
        ...
        strategy = AroonOscillatorStrategy(**params)
...
def main():
    print("=" * 60)
    print("Aroon Oscillator — KRX Real Data Backtest")
    print("=" * 60)
    ...
    for period_name, (start, end) in PERIODS.items():
        ...
        strategy = AroonOscillatorStrategy(**best_params)
    ...
    out_path = os.path.join(os.path.dirname(__file__), "aroon_results.json")
