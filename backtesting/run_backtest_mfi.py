"""
MFI (Money Flow Index) Mean Reversion backtest.
In-Sample: 2019-2022, Out-of-Sample: 2023-2024.
Parameter optimization: mfi_period, oversold, overbought, sma_filter, stop_loss.
"""
...
from strategies import MFIMeanReversionStrategy
...
PARAM_GRID = {
    ...
    "sma_filter": [50, 100, 200],
    "stop_loss":  [0.03, 0.05, 0.07],
}


def cross_sectional_aggregate(per_stock_results, strategy_name="MFI Mean Reversion"):
...
def optimize(stock_data):
    ...
    for combo in combos:
        ...
        strategy = MFIMeanReversionStrategy(**params)
...
def main():
    print("=" * 60)
    print("MFI Mean Reversion — Backtest")
    print("=" * 60)
    ...
    if best_params is None:
        ...
        best_params = {"mfi_period": 14, "oversold": 20.0, "overbought": 80.0, "sma_filter": 50, "stop_loss": 0.04}
    ...
    for period_name, (start, end) in PERIODS.items():
        ...
        strategy = MFIMeanReversionStrategy(**best_params)
    ...
    out_path = os.path.join(os.path.dirname(__file__), "mfi_results.json")
