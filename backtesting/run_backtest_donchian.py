"""
Donchian Channel Breakout backtest.
In-Sample: 2019-2022, Out-of-Sample: 2023-2024.
Parameter optimization: entry_period, exit_period, adx_threshold, atr_stop_mult.
"""
...
from strategies import DonchianChannelBreakoutStrategy
...
def cross_sectional_aggregate(per_stock_results, strategy_name="Donchian Channel Breakout"):
...
def optimize(stock_data):
    ...
    for combo in combos:
        ...
        strategy = DonchianChannelBreakoutStrategy(**params)
...
def main():
    ...
    if best_params is None:
        ...
        best_params = {"entry_period": 20, "exit_period": 10, "adx_threshold": 25.0, "atr_stop_mult": 2.0}
    ...
    for period_name, (start, end) in PERIODS.items():
        ...
        strategy = DonchianChannelBreakoutStrategy(**best_params)
