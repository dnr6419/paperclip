"""
TRIX Momentum backtest.
In-Sample: 2019-2022, Out-of-Sample: 2023-2024.
Parameter optimization: trix_period, signal_period, stop_loss, take_profit.
"""
...
from strategies.trix_momentum import TRIXMomentumStrategy
...
def cross_sectional_aggregate(per_stock_results, strategy_name="TRIX Momentum"):
...
def optimize(stock_data):
    ...
    for combo in combos:
        ...
        strategy = TRIXMomentumStrategy(**params)
...
def main():
    ...
    for period_name, (start, end) in PERIODS.items():
        ...
        strategy = TRIXMomentumStrategy(**best_params)
    ...
    out_path = os.path.join(os.path.dirname(__file__), "trix_momentum_results.json")
