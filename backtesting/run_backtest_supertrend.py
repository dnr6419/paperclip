"""
Supertrend Trend-Following backtest.
In-Sample: 2019-2022, Out-of-Sample: 2023-2024.
Parameter optimization: atr_period, multiplier, volume_filter, stop_loss.
"""
...
def cross_sectional_aggregate(per_stock_results, strategy_name="Supertrend Trend-Following"):
...
def main():
    print("=" * 60)
    print("Supertrend Trend-Following — Backtest")
    print("=" * 60)
    ...
    if best_params is None:
        ...
        best_params = {"atr_period": 10, "multiplier": 3.0, "volume_filter": True, "stop_loss": 0.05}
    ...
    for period_name, (start, end) in PERIODS.items():
        ...
        strategy = SupertrendStrategy(**best_params)
    ...
    out_path = os.path.join(os.path.dirname(__file__), "supertrend_results.json")
