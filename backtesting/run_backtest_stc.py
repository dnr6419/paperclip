"""
Schaff Trend Cycle (STC) backtest on KRX real data.
In-Sample: 2019-2022, Out-of-Sample: 2023-2024.
Parameter optimization: fast_period, slow_period, cycle_period, buy/sell thresholds, stop_loss, take_profit.
"""
...
from strategies.schaff_trend_cycle import SchaffTrendCycleStrategy
...
def cross_sectional_aggregate(per_stock_results, strategy_name="Schaff Trend Cycle"):
...
def optimize(stock_data):
    ...
    for combo in combos:
        ...
        strategy = SchaffTrendCycleStrategy(**params)
...
def main():
    print("=" * 60)
    print("Schaff Trend Cycle (STC) — KRX Real Data Backtest")
    print("=" * 60)
    ...
    for period_name, (start, end) in PERIODS.items():
        ...
        strategy = SchaffTrendCycleStrategy(**best_params)
    ...
    out_path = os.path.join(os.path.dirname(__file__), "stc_results.json")
