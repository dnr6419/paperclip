"""
KRX backtest runner: 11 strategies on synthetic Korean market data.
...
from backtesting.generate_data_krx import generate_all_krx_data
...
def main():
    print("=" * 60)
    print("BACKTESTING RUNNER — 11 Strategies, Synthetic KRX Universe")
    print("=" * 60)
    print("\nGenerating synthetic KRX market data (2019-2024)...", flush=True)
    all_data = generate_all_krx_data("2019-01-01", "2024-12-31")
    ...
    out_path = os.path.join(os.path.dirname(__file__), "results_krx.json")
