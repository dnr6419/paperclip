"""
Connors RSI Mean Reversion backtest on KRX real data.
In-Sample: 2019-2022, Out-of-Sample: 2023-2024.
Parameter optimization: rsi_period, oversold, overbought, stop_loss, take_profit.
"""
...
def cross_sectional_aggregate(per_stock_results, strategy_name="Connors RSI"):
...
def optimize(stock_data):
    ...
    for combo in combos:
        ...
        strategy = ConnorsRSIStrategy(**params)
...
def main():
    print("=" * 60)
    print("Connors RSI Mean Reversion — KRX Real Data Backtest")
    print("=" * 60)
    ...
    for period_name, (start, end) in PERIODS.items():
        ...
        strategy = ConnorsRSIStrategy(**best_params)
    ...
    out_path = os.path.join(os.path.dirname(__file__), "connors_rsi_results.json")
