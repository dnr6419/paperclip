"""
Coppock Curve backtest on KRX real data.
In-Sample: 2019-2022, Out-of-Sample: 2023-2024.
Parameter optimization: roc_long, roc_short, wma_period, stop_loss, take_profit.
"""
...
from strategies.coppock_curve import CoppockCurveStrategy
...
def cross_sectional_aggregate(per_stock_results, strategy_name="Coppock Curve"):
...
def optimize(stock_data):
    ...
    for combo in combos:
        ...
        strategy = CoppockCurveStrategy(**params)
...
def main():
    print("=" * 60)
    print("Coppock Curve — KRX Real Data Backtest")
    print("=" * 60)
    ...
    for period_name, (start, end) in PERIODS.items():
        ...
        strategy = CoppockCurveStrategy(**best_params)
    ...
    out_path = os.path.join(os.path.dirname(__file__), "coppock_results.json")
