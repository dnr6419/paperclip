"""
ATR Volatility Breakout backtest.
In-Sample: 2019-2022, Out-of-Sample: 2023-2024.
Parameter optimization: lookback, atr_period, breakout_mult, stop_loss, take_profit.
"""
...
PARAM_GRID = {
    "lookback":      [15, 20, 30],
    "atr_period":    [10, 14, 20],
    "breakout_mult": [0.5, 0.7, 1.0],
    "stop_loss":     [0.04, 0.05, 0.07],
    "take_profit":   [0.15, 0.20, 0.25],
}


def cross_sectional_aggregate(per_stock_results, strategy_name="ATR Breakout"):
...
def main():
    print("=" * 60)
    print("ATR Volatility Breakout — Backtest")
    print("=" * 60)
    ...
    out_path = os.path.join(os.path.dirname(__file__), "atr_breakout_results.json")
