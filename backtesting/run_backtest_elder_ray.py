"""
Elder Ray Index backtest on KRX real data.
In-Sample: 2019-2022, Out-of-Sample: 2023-2024.
Parameter optimization: ema_period, stop_loss, take_profit.
"""
...
from strategies.elder_ray import ElderRayStrategy
...
def cross_sectional_aggregate(per_stock_results, strategy_name="Elder Ray"):
...
def optimize(stock_data):
    ...
    for combo in combos:
        ...
        strategy = ElderRayStrategy(**params)
...
def main():
    print("=" * 60)
    print("Elder Ray Index — KRX Real Data Backtest")
    print("=" * 60)
    ...
    for period_name, (start, end) in PERIODS.items():
        ...
        strategy = ElderRayStrategy(**best_params)
    ...
    out_path = os.path.join(os.path.dirname(__file__), "elder_ray_results.json")
