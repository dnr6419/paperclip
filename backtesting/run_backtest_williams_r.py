"""
Williams %R Mean Reversion backtest.
In-Sample: 2019-2022, Out-of-Sample: 2023-2024.
Parameter optimization: wr_period, oversold, overbought, sma_filter.
"""
...
from strategies import WilliamsRReversionStrategy
...
def cross_sectional_aggregate(per_stock_results, strategy_name="Williams %R Mean Reversion"):
...
def optimize(stock_data):
    ...
    for combo in combos:
        ...
        strategy = WilliamsRReversionStrategy(**params)
...
def main():
    print("=" * 60)
    print("Williams %R Mean Reversion — Backtest")
    print("=" * 60)
    ...
    if best_params is None:
        ...
        best_params = {"wr_period": 14, "oversold": -80.0, "overbought": -20.0, "sma_filter": 50}
    ...
    for period_name, (start, end) in PERIODS.items():
        ...
        strategy = WilliamsRReversionStrategy(**best_params)
    ...
    out_path = os.path.join(os.path.dirname(__file__), "williams_r_results.json")
