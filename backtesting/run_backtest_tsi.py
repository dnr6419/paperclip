"""
True Strength Index (TSI) Momentum backtest on KRX real data.
In-Sample: 2019-2022, Out-of-Sample: 2023-2024.
Parameter optimization: fast_period, slow_period, signal_period, stop_loss, take_profit.
"""
...
from strategies.tsi_momentum import TSIMomentumStrategy
...
def cross_sectional_aggregate(per_stock_results, strategy_name="TSI Momentum"):
...
def optimize(stock_data):
    ...
    for combo in combos:
        ...
        strategy = TSIMomentumStrategy(**params)
...
def main():
    print("=" * 60)
    print("True Strength Index (TSI) Momentum — KRX Real Data Backtest")
    print("=" * 60)
    ...
    for period_name, (start, end) in PERIODS.items():
        ...
        strategy = TSIMomentumStrategy(**best_params)
    ...
    out_path = os.path.join(os.path.dirname(__file__), "tsi_results.json")
